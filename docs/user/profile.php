<?php 
<<<<<<< HEAD:docs/user/profile.php
require_once('../../system/templates/header_template.html');
=======
require_once('system/template/class_template.php');
>>>>>>> parent of d9c34f6... Profile page almost complete. Importing top part from main template page:docs/public/profile.php
?>
...
<<<<<<< HEAD:docs/user/profile.php
                <li><a href="../public/user.php">Dashboard</a></li>
                <li class="current"><a href="../user/public.php" title="">Profile</a></li>
=======
