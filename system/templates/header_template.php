...
<script type="text/javascript" src="../../js/parse/initialize.js"></script>
    ...
    <div class="wrapper">
        ...
        <div class="topNav">
            <ul class="userNav">
                ...
                <li><a title="" class="logout" id="logOut"></a></li>
        ...
        <ul class="altMenu">
            ...
            <li><a href="ui.html" title="" class="exp" id="current">Students & Tutors</a>
            </li>
            <li><a href="forms.html" title="" class="exp">Submit a Geo</a>
            </li>
            <li><a href="messages.html" title="">Message Board</a></li>
...
<div id="sidebar">
    <div class="mainNav">
        ...
        <!-- Main nav -->
        <ul class="nav">
            <li><a href="index.html" title="" class="active"><img src="../../images/icons/mainnav/dashboard.png" alt="" /><span id="UniversityShortFormDash"></span></a></li>
            <li><a href="ui.html" title=""><img src="../../images/icons/mainnav/ui.png" alt="" /><span>Students & Tutors</span></a>
            </li>
            <li><a href="forms.html" title=""><img src="../../images/icons/mainnav/forms.png" alt="" /><span>Submit a Geo</span></a>
            </li>
            <li><a href="messages.html" title=""><img src="../../images/icons/mainnav/messages.png" alt="" /><span>Message Board</span></a></li>
    ...
    <div class="secNav">
        <div class="secWrapper">
            <div class="secTop">
                <div class="balance">
                    <div class="balInfo">Welcome:<span id="CurrentDate"></span></div>
                    <div class="balAmount"><span class="balBars"><!--5,10,15,20,18,16,14,20,15,16,12,15--></span><span>$58,990</span></div>
                </div>
            </div>
            ...
            <div id="tab-container" class="tab-container">
                ...
                <div id="general">
                    <!-- Stuff for first tab can go in here -->
                    <!-- Sidebar forms -->
                ...
                <div id="alt2">
                    ...
                    <!-- stuff for last tab can go here -->
                </div>
            </div>
